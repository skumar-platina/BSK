view: fact_booking_daily {
  sql_table_name: "FINANCE"."FACT_BOOKING_DAILY"
    ;;
  ...
  dimension: cost_at_booking_per_unit {
    type: number
  ...
  dimension: f_bookigs_daily_key {
    type: number
    sql: ${TABLE}."F_BOOKIGS_DAILY_KEY" ;;
  }
